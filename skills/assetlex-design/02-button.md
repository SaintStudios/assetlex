...
- **primary**: the one accent, with a bevel built by color-mixing the accent
  toward deep indigo `#064e3b`, a white inset highlight on top and a dark
 ...
 * deep indigo (#064e3b) for its border and resting fill, then lightening to
...
const VARIANTS: Record<Variant, string> = {
  primary:
    ...
    "shadow-[inset_0_1px_0_rgba(255,255,255,0.22),inset_0_-1px_0_rgba(6,78,59,0.30)] " +
